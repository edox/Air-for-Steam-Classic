"steam/cached/SettingsSubVoice.res"
{
	layout
	{
		...
		place { control="TransmitMethodRadioButton3"				region=box dir=down start=TransmitMethodRadioButton2 margin-top=-2 }
		place { control="PushToTalkKeyEntry"						region=box dir=down width=280 height=24 start=TransmitMethodRadioButton3 margin-top=10 }
