"steam/cached/SettingsSubFriends.res"
{
  ...
  layout
  {
    ...
    place { control="LabelGroupEvents"						region=box dir=down start=ReceiveMessagePlaySoundCheck margin-top=20 }
    place { control="EventsAndAnnouncementsNotifyCheck"		region=box dir=down start=LabelGroupEvents margin-top=5 }
    place { control="EventsAndAnnouncementsPlaySoundCheck"	region=box dir=down start=EventsAndAnnouncementsNotifyCheck margin-top=-2 }

    place { control="Divider2"						region=box dir=down start=EventsAndAnnouncementsPlaySoundCheck margin-top=13 }
